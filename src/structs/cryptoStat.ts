...
export default class CryptoStat {
    ...
    static percent_change_1h = new CryptoStat("1h%", "1 hour price change percentage");
    static percent_change_24h = new CryptoStat("24h%", "24 hour price change percentage");
    static percent_change_7d = new CryptoStat("7d%", "7 day price change percentage");
