...
export async function makeEmbed(coin: CoinMetadata) {
    ...
    const movingAverages = `SMA(5): ${indicators.sma5} - ${price < indicators.sma5 ? "Bearish " + emojis["bearish"] : price > indicators.sma5 ? "Bullish " + emojis["bullish"] : "Neutral"}
        ...
        fields: [
            {
                ...
                Verdict: **${bullishIndicatorCount > bearishIndicatorCount ? "Bullish " + emojis["bullish"] : bullishIndicatorCount < bearishIndicatorCount ? "Bearish " + emojis["bearish"] : "Neutral"}** (Bullish: ${bullishIndicatorCount}, Bearish: ${bearishIndicatorCount})`
            },
            {
                name: "Moving Averages",
                value: `${movingAverages}
                
                Verdict: **${bullishMovingAverageCount > bearishMovingAverageCount ? "Bullish " + emojis["bullish"] : bullishMovingAverageCount < bearishMovingAverageCount ? "Bearish " + emojis["bearish"] : "Neutral"}** (Bullish: ${bullishMovingAverageCount}, Bearish: ${bearishMovingAverageCount})`
            }
        ]
    };
    return embed;
